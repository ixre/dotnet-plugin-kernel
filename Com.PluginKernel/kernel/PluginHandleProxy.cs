...
namespace Com.PluginKernel
{
    ...
    public abstract class PluginHandleProxy<T> : IPluginHandleProxy<T>
    {
        ...
        public object HanleRequestUse<HandleClass>(HandleClass t, T context, string action, string source)
        {
            Type type = t.GetType();
        ...
        public object HanleRequestUse<HandleClass>(
            HandleClass t,
            T context,
            string action)
        {
            return HanleRequestUse(t, context, action, null);
        }
